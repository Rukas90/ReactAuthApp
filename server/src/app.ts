...
import { useUserRoutes } from "#features/user/controller/user.controller"
import { useAuthRoutes } from "#features/auth/controller/auth.controller"
...
app.use(
  cors({
    origin: ["http://192.168.1.119:5173", "http://localhost:5173"],
    credentials: true,
